...
// --------------------------------------------------------------
void setup() {
// Esperamos hasta que el puerto serie esté disponible.
// Esto permite asegurarnos de que podemos comunicarnos 
 //con el ordenador antes de continuar.
 ...
 //                          BLUETOOTH 
 // ------------------------------------------------------------//
 // A partir de aquí podemos empezar a emitir anuncios BLE.
...
// --------------------------------------------------------------
// --------------------------------------------------------------
//Función para saber si esta funcionando
...
void loop () {
  ...
  using namespace Loop; //uso las variables Loop
  using namespace Globales; //uso las variables Globales
  ...
  elPublicador.laEmisora.emitirAnuncioIBeaconLibre ( "MolaMolaMolaMolaMolaM", 21 ); //El segundo parámetro indica que queremos enviar 21 bytes.
