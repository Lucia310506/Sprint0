...
// 2019-07-07
// ----------------------------------------------------------
#ifndef EMISORA_H_INCLUIDO //Si no esta definido definelo
...
public:
  ...
  */
  ...
  void encenderEmisora( CallbackConexionEstablecida cbce,
	...
	encenderEmisora();// enciende

	instalarCallbackConexionEstablecida( cbce ); //establece conexion
	instalarCallbackConexionTerminada( cbct ); //establece conexion
  ...
  void detenerAnuncio() {
	...
	if ( (*this).estaAnunciando() ) {
	  ...
	  Bluefruit.Advertising.stop(); //Bluetooth detenido
	}
  ...
  // .........................................................
  bool estaAnunciando() {
	return Bluefruit.Advertising.isRunning();//esta activa
  } // ()
  ...
  void emitirAnuncioIBeacon( uint8_t * beaconUUID, int16_t major, int16_t minor, uint8_t rssi ) {
	...
	//
	//
	(*this).detenerAnuncio(); //Paro el anuncio
...
// Configura la potencia de transmisión.
  ...
  */
  void emitirAnuncioIBeaconLibre( const char * carga, const uint8_t tamanyoCarga ) {
	...
	//
	// Si se desconecta alguien, vuelve a anunciar.
	Bluefruit.Advertising.restartOnDisconnect(true);
	Bluefruit.Advertising.setInterval(100, 100);    // intervalo de emision
  ...
  bool anyadirServicioConSusCaracteristicasYActivar( ServicioEnEmisora & servicio,
	...
	servicio.activarServicio();//activa.
